...
<head>
    ...
    <title>Sklep z kasztanami</title>
...
<body>
    ...
    <div id="paneleDoktora">
        <div id="lewyPanelDoktora">
            ...
            <button id="btnZarzadzajPacjentem" class="przyciskDoktora"><span
                    class="material-symbols-outlined">manage_accounts</span><span class="tekstPrzycisku">Zarządzaj
                    pacjentem</span></button>
        ...
        <div id="prawyPanelDoktora">
            <div id="statyKontener">
                ...
                <div class="statyItem" style="background-color:#f29c10;">
                    <div class="statyItemText">
                        ...
                        $sql = "SELECT COUNT(*) AS liczba_wizyt FROM wizyty WHERE id_lekarza = 2 AND data_wizyty >= CURDATE();";
                        $result = mysqli_query($con, $sql);
                ...
                <div class="tabelaStatyHolder" id="tabelaStatyHolderWizyty" style="display:none;">
                    <div class="tabelaPodStaty" id="tabelaPodStatyWizyty">
                        <?php
                        $sql = "SELECT * FROM wizyty WHERE id_lekarza=" . $_SESSION['doctor_id'] . " ORDER BY data_wizyty DESC";
                        $result = mysqli_query($con, $sql);
            ...
            <div id="wyszukiwaniePacjenta">
                <input type="text" id="pacjentSearchBar" placeholder="Wpisz imię pacjenta">
